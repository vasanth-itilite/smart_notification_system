...
def initialize_database():
    ...
    db_path = os.path.abspath("travel_info.db")
                        ...
                        for message_type in message_types:
                            ...
                            try:
                                cursor.execute(
                                    ...
                                    (trip_id, leg_request_id, message_type, notification, quick_tips, extra_info, raw_leg, email) 
                                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                                    ''',
                                    (
                                        request.trip_id,
